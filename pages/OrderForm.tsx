...
const OrderForm = (): React.JSX.Element => {
  ...
  const onSubmit = async (data: OrderFormData) => {
    ...
    try {
        ...
        // Step 5: Insert data and get the auto-generated order number
        ...
        if (!insertedData) throw new Error('Failed to create order and retrieve order number.');

        // Step 6: Get the auto-generated order number from the database
        const orderNumber = insertedData.order_number_text;

        if (!orderNumber) {
            console.error('CRITICAL: Order number was not auto-generated by the database.');
            throw new Error('Failed to generate order number. Please contact support.');
        }
